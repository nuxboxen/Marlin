...
//#define LCD_SHOW_E_TOTAL
  ...
  #define SD_FINISHED_RELEASECOMMAND "M84 X Y Z E"  // Use "M84XYE" to keep Z enabled so your bed stays in place     changed by Nux
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY      // changed by Nux
    ...
    #define POWER_LOSS_PURGE_LEN   20 // (mm) Length of filament to purge on resume                            changed by Nux
    #define POWER_LOSS_RETRACT_LEN 10 // (mm) Length of filament to retract on fail. Requires backup power.    changed by Nux
   ...
   */
  #define SD_ABORT_ON_ENDSTOP_HIT             //     changed by Nux
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 2000   // Maximum interval between clicks, in milliseconds.    Changed by Nux
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g. 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE  32          //changed by Nux
...
#define TX_BUFFER_SIZE 32                //changed by Nux
